                ...
                <div className="bg-white">
                  <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                    <Link to="/admin/product-form">
                      <button
                        type="button"
                        className="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black active:scale-95 duration-200"
                      >
                        Add New Product
                      </button>
                    </Link>
                            ...
                            <Link to={`/product/${product.id}`}>
                              ...
                              <div className="mt-4 flex justify-between">
                                <div>
                                  ...
                                  <p className="mt-1 text-sm font-semibold flex items-center text-gray-500">
                                    {product.rating}
                                    <StarIcon
                                      strokeWidth={3}
                                      absoluteStrokeWidth
                                      className="w-4 h-4 ml-1 inline text-yellow-500"
                                    />
                                  </p>
                                </div>
                                <div>
