                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      {items.length > 0 && (
                        <span className="inline-flex items-center rounded-full bg-green-50 px-2 py-1 text-xs font-medium mb-7 -ml-1 text-green-700 z-10 ring-1 ring-inset ring-green-600/20">
                          {items.length}
                        </span>
                      )}
                      {/* Profile dropdown */}
                      <Menu as="div" className="relative ml-3">
                        <div>
                          <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                            ...
                            <img
                              className="h-8 w-8 rounded-full object-fill object-center"
                              ...
                              <Menu.Item key={item.name}>
                                {({ active }) => (
                                  <Link
                                    ...
                                    className={classNames(
                                      active ? "bg-gray-100" : "",
                                      "block px-4 py-2 text-sm antialiased font-medium text text-gray-700"
                                    )}
                                  >
                                    {item.name}
                                  </Link>
